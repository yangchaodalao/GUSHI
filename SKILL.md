...
description: 采集24小时内中国大陆官方新闻头条和当日A股市场数据，生成 Markdown 日报文件。当用户提到"今日股市""A股行情""市场日报""财经简报""大盘数据""今天涨跌""股市数据""财经新闻汇总""今天大盘""行情怎么样""涨了没""收盘""股市日报""财经日报"等需求时使用此 skill。即使只模糊提到"今天行情怎么样"或"今天涨了还是跌了"也应该触发此 skill。不要尝试自己拼凑数据，不要凭记忆回答指数点位。
...
> 📌 今日休市，股市数据见 [[A股市场日报_{{LAST_TRADING_DATE}}|上一交易日报告]]。
```

**查找上一交易日文件名**：用 Glob 列出 `A股市场日报_*.md`，按文件名日期倒序取第一条，提取其日期填入 `[[A股市场日报_YYYY-MM-DD]]`。
